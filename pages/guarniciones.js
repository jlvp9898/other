...
export default function Guarniciones({ data, banner }) {
  ...
  useMemo(async () => {
    ...
    fetch(api.urlApi("data_fittings&lang="+lang), { method: 'GET', headers})
...
export async function getStaticProps() {
  // const menuData = getMenuData(params.type);
  const menuData = getMenuData("guarniciones");
